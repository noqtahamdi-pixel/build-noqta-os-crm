...
export default async function Page() {
  ...
  return <Shell user={{ email: user.email ?? '', role, mfa: false }} styles={styles ?? []} categories={categories ?? []} subcategories={subcategories ?? []} dataError={stylesError?.message ?? categoriesError?.message ?? subcategoriesError?.message ?? null} />
}
